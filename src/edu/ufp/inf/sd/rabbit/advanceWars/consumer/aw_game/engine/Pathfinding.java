...
public class Pathfinding {
	...
	private edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.units.Base unit;
	...
	public Vector<Point> FindPath(edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.units.Base unit, int range) {

...
public class Editor {
	...
	public void StartEditor(String name, int height, int width) {
		...
		Game.builds = new ArrayList<edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.buildings.Base>();
	...
	public void AssButton() {
		...
		case CITY:
			AddBuilding();
			Game.map.map[selecty][selectx] = new edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.terrain.City();
		break;
		case UNIT:
	...
	public void ButtButton() {
		new edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.menus.EditorStuff();
	}
	
	private void AddBuilding() {
		moved = false;//Keeps game from generating lots of useless edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.buildings.

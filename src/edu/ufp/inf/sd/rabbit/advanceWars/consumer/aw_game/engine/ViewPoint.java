 ...
 * Place MoveView(); in the game-loop (100ms) to automate it (Teleporting across the map between switching viewed edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.units / turns is automatic)
...
public class ViewPoint {
	 ...
	 * @return = True when in view range, false when outside of it. (edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.saves time so you don't have to render images)
	 */

package edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.players;
...
public class Base {
	...
	public int usedunits;//How many edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.units does the player have left until turn ends. Currently unused.
	public int kills;
	public int loses;
	...
	/**The first special ability the player can use when the edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.players power>level1. leave level1 at 0 to remove access to this ability.*/

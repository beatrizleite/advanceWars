...
//	String path = "maps";
	String path = "/home/bea/Documents/advanceWars/src/edu/ufp/inf/sd/rabbit/advanceWars/consumer/aw_game/maps";
	...
	public void encode(String mapname) {
		...
		if (!directory.exists()) {
	    	...
	    	else {Game.error.ShowError("Cannot create the edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.maps directory. " + path + "");return;}
		}
	...
	private String encodeInfo() {//TODO: Total edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.players. (start with 2, and add more depending on unit and building owners.)
	...
	private String encodeDesc() {
		//TODO: Replace name with current edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.players name, and leave description for manliness?
	...
	private String encodeUnits() {
		...
		if (!Game.units.isEmpty()) {
			units+="\n5 ";
			for (edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.units.Base unit : Game.units) {
				units+=UnitID(unit);
	...
	private String CityID(edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.buildings.Base bld) {
		String a = "00";
	...
	private String UnitID(edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.units.Base unit) {
		String a = "00";
	...
	private List<edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.buildings.Base> FormatCities(List<edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.buildings.Base> oldblds) {
		List<edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.buildings.Base> newblds = new ArrayList<edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.buildings.Base>();
	 ...
	 * xx = Map Width
	 * yy = Map Height
	 * x = Total edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.players*/
	...
	/**This is for decoding the edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.terrain, it currently goes with 1 line = 1 row
	 * 2 = Byte
	 ...
	 * f = Owner (0-11 are edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.players, 15 is neutral, 12-14 are unused)
	 * ff = type
	 * x location (x)
	 * y location (y)*/

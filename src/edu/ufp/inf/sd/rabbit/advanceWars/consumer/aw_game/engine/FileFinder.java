...
public class FileFinder {
	...
	public DefaultListModel GrabMaps() {
		...
		if (folder.mkdir()) {
		    ...
		    //TODO: Transfer pre-made map files into here, or include src/edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.maps/ to the list of edu.ufp.inf.sd.rabbit.advanceWars.consumer.aw_game.maps somehow.
		}

...
#export JAVAPROJ=/Documents/${JAVAPROJ_NAME}
...
export SERVICE_NAME_ON_REGISTRY=AdvanceWarsService
export CLIENT_CLASS_PREFIX=AdvanceWars
export SERVER_CLASS_PREFIX=AdvanceWars
...
export CLASSPATH=.:${JAVAPROJ_CLASSES_FOLDER}:${JAVAPROJ}/lib/jackson-annotations-2.14.2.jar:${JAVAPROJ}/lib/jackson-core-2.14.2.jar:${JAVAPROJ}/lib/jackson-databind-2.14.2.jar:${JAVAPROJ}/lib/java-jwt-4.4.0.jar

...
#@REM ==== PC STUFF ====
export JDK=/usr/lib/jvm/java-19-openjdk-amd64/bin/java
...
export JAVAPROJ_NAME=advanceWars
export JAVAPROJ=/home/${USERNAME}/Documents/${JAVAPROJ_NAME}
export RABBITMQ_SERVICES_FOLDER=edu/ufp/inf/sd/rabbit
export RABBITMQ_SERVICES_PACKAGE=edu.ufp.inf.sd.rabbit
export PACKAGE=advanceWars
export QUEUE_NAME_PREFIX=advanceWars
export EXCHANGE_NAME_PREFIX=advanceWars
...
export JAVA_RABBITMQ_TOOLS=${JAVA_LIB_FOLDER}/amqp-client-5.11.0.jar:${JAVA_LIB_FOLDER}/slf4j-api-1.7.30.jar:${JAVA_LIB_FOLDER}/slf4j-simple-1.7.30.jar:${JAVAPROJ}/lib/jackson-annotations-2.14.2.jar:${JAVAPROJ}/lib/jackson-core-2.14.2.jar:${JAVAPROJ}/lib/jackson-databind-2.14.2.jar:${JAVAPROJ}/lib/java-jwt-4.4.0.jar
